    ...
    <div class="min-h-screen bg-zinc-50 flex flex-col justify-center py-12 px-6 lg:px-8 font-sans">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-center text-sm text-zinc-600">
                Empieza a gestionar tus archivos hoy mismo
            </p>
        </div>
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[440px]">
            <div class="bg-white py-10 px-8 shadow-sm border border-zinc-200 rounded-2xl">
                <form action="{{ route('auth.register') }}" method="POST" class="space-y-6">
                    @csrf
                    <div>
                        <label for="name" class="block text-sm font-semibold text-zinc-900 mb-2">
                            Nombre completo
                        </label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-semibold text-zinc-900 mb-2">
                ...
                <div class="mt-8">
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm font-medium leading-6">
                            <span class="bg-white px-4 text-zinc-500">O regístrate con</span>
                        </div>
                    </div>

                    <div class="mt-6">
                        <button type="button"
                            class="flex w-full items-center justify-center gap-3 rounded-lg border border-zinc-300 bg-white px-4 py-2.5 text-sm font-semibold text-zinc-900 shadow-sm hover:bg-zinc-50 ring-1 ring-inset ring-zinc-300 focus:ring-zinc-900 transition-all">
                            <svg class="h-5 w-5" aria-hidden="true" viewBox="0 0 24 24">
                                <path
                                    d="M12.48 10.92v3.28h7.84c-.24 1.84-.909 3.157-1.901 4.148-1.223 1.223-3.11 2.56-6.419 2.56-5.174 0-9.282-4.182-9.282-9.358S6.826 3.012 12 3.012c2.73 0 4.816 1.083 6.362 2.53l2.313-2.313C18.298 1.05 15.53 0 12 0 5.4 0 0 5.4 0 12s5.4 12 12 12c3.58 0 6.26-1.18 8.35-3.35 2.14-2.14 2.82-5.16 2.82-7.53 0-.71-.06-1.39-.17-2.02h-10.52z"
                                    fill="currentColor" />
                            </svg>
                            <span>Google</span>
                        </button>
            ...
            <p class="mt-8 text-center text-sm text-zinc-600">
                ...
                <a href="{{ route('login') }}" class="font-semibold text-zinc-900 hover:underline decoration-zinc">
                    Inicia sesión
                </a>
            </p>
        </div>
